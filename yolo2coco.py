...
parser.add_argument('--image_path', default=r'D:\learn\zuhui\ultralytics-20240330\ultralytics-main\dataset\SSDD\images\val',type=str, help="path of images")
parser.add_argument('--label_path', default=r'D:\learn\zuhui\ultralytics-20240330\ultralytics-main\dataset\SSDD\labels\val',type=str, help="path of labels .txt")                                                             
